# Taken from https://github.com/vimjoyer/nixconf/blob/main/nixosModules/features/impermanence.nix
# Impermanence Lets you choose what files and directories you want to keep between reboots - the rest are thrown away.
{
  pkgs,
  lib,
  inputs,
