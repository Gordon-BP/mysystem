...
monitor = HDMI-A-2, 1920x1080, 1080x0, 1
monitor = HDMI-A-1, 1920x1080@90, 0x0, 1, transform, 1
...
exec-once = hypridle
exec-once = expressvpn activate & expressvpn connect Malaysia
exec-once = waybar & hyprpaper

source = ~/mysystem/usrModules/macchiato.conf
